...
class LoadAssetQuestionCategoriesUsecase
    extends UseCase<Future<DataState<List<QuestionCategory>>>, NoParams> {
  LoadAssetQuestionCategoriesUsecase({required this.questionRepository});
  ...
  Future<DataState<List<QuestionCategory>>> call({
    ...
    return questionRepository.loadAssetQuestionCategories();
  }
}
